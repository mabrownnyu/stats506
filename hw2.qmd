...
n <- 10000
tests10 <- 1:n
tests10 <- sapply(tests, FUN=vectorWalk, num=10)
100 * sum(tests10==0) / length(tests10)

tests100 <- 1:n
tests100 <- sapply(tests, FUN=vectorWalk, num=100)
...
When the number of steps is 10, the probability of the final step of the walk being 0 is 15.9%. When the number of steps is 100, the probability of the final step of the walk being 0 is 0.004%. When the number of steps is 1000, the probability of the final step of the walk being being 0 is 1.34%. I estimated these values by conducting 10k of the random walks and then calculating the number of times the final step was 0.
...
# I used slides from STATS 500 Fall 2024 to verify that this code 
# was correct. 
xtx <- t(X) %*% X
xtxi <- solve(xtx)
